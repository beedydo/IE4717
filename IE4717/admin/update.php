		...
		<body>
			<div id="wrapper">
				<div id="main">
					...
					<div id="content">
						<h1><b>Update products here: </b></h1>
							
							<form method="UPDATE" action="updateproduct.php">
								<label for="product_type" class="addproduct_label" class="updateproductlabel">Product Type:</label>
